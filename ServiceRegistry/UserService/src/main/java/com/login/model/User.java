...
public class User {
    ...
    @Pattern(regexp = "^(ADMIN|FARMER|DEALER)$", message = "Role must be one of ADMIN, FARMER, or DEALER")
    @Column(name = "role", nullable = false, length = 20)
    private String role;

    @NotBlank(message = "Address is required")
    @Size(min = 10, message = "Address must be at least 10 characters long")  // Updated message
